          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                ...
                <div class="form-group" >
                  ...
                  <div class="col-sm-10">
                    <input name="id_pendaftar" type="text" readonly value="<?=$kodeunik?>" class="form-control" placeholder="">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="nama_pemilik_perusahaan" type="text" class="form-control" placeholder="Nama pemilik perusahaan" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="alamat_perusahaan" type="text" class="form-control" placeholder="Alamat kantor" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="nomor_telepon_perusahaan" type="text" class="form-control" placeholder="Telepon fax kantor" required>
                  </div>
                </div>
              </div>
              </div>
              ...
              <div class="tab-pane" id="tab_2">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Jenis badan usaha</label>
                    <div class="col-sm-10">
                    <select name="jeniz_badan_usaha" id="investasi" type="text" class="form-control" required>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="nilai_investasi" id="investasi" type="text" class="form-control" required>
              ...
              <div class="tab-pane" id="tab_3">
                ...
                <div class="col-sm-10">
                    <select name="jumlah_tenaga_kerja" id="sdm" type="text" class="form-control" required>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="user_name" readonly value="<?=$kodeunik?>" class="form-control" required>
                </div>
                </div>
              ...
              <div class="box-footer">
                <a href="<?php echo base_url(); ?>index.php/admin/C_pendaftar"><submit class="btn btn-default pull-left">Kembali</submit></a>
