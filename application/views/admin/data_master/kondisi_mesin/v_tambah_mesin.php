      ...
      <h1>
        Tambah Data Kondisi Mesin
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?= base_url('index.php/admin/C_mesin/proses_tambah_data_kondisi_mesin') ?>" method="POST" class="form-horizontal">
              <div class="box-body">

                <div class="form-group"> 
                  <label class="col-sm-2 control-label">ID KONDISI MESIN</label>

                  <div class="col-sm-10">
                    <input name="id_kondisi_mesin" type="text" readonly value="<?=$kodeunik?>" class="form-control" placeholder="Masukkan ID ">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="jenjang_kondisi_mesin" type="text" class="form-control" placeholder="Masukkan " required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="bobot_kondisi_mesin" type="text" class="form-control" placeholder="Masukkan " required>
                  </div>
                </div>
