...
<head>
  ...
  $().ready(function(){
      ...
      $('#ID_ADMINISTRATOR').change(function(){
        var id = $('#ID_ADMINISTRATOR').val();
        // alert(id);
        $('#ganti_nama_level').load("<?php echo base_url()?>index.php/admin/C_user/pilih_user/"+id);
      });
  });
  </script>
</head>
      ...
      <ol class="breadcrumb">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?= base_url('index.php/admin/C_user/proses_tambah_data_user')?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="user_name"  class="form-control" placeholder="Masukkan username" onchange="update_pengurus()" required>
                  </div>
                </div> 
