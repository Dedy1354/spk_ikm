      ...
      <h1>
        Tambah Data Izin Industri
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?= base_url('index.php/admin/C_izin/proses_tambah_data_izin') ?>" method="POST" class="form-horizontal">
              <div class="box-body">

                <div class="form-group"> 
                  <label class="col-sm-2 control-label">ID izin industri </label>

                  <div class="col-sm-10">
                    <input name="id_izin_industri" type="text" readonly value="<?=$kodeunik?>" class="form-control" placeholder="Masukkan ID ">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="jenjang_izin_industri" type="text" class="form-control" placeholder="Masukkan " required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="bobot_izin_industri" type="text" class="form-control" placeholder="Masukkan " required>
                  </div>
                </div>
