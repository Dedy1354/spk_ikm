      ...
      <h1>
        Tambah Data Partisipasi
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?= base_url('index.php/admin/C_partisipasi/proses_tambah_data_partisipasi') ?>" method="POST" class="form-horizontal">
              <div class="box-body">

                <div class="form-group"> 
                  <label class="col-sm-2 control-label">ID PARTISIPASI</label>

                  <div class="col-sm-10">
                    <input name="id_partisipasi" type="text" readonly value="<?=$kodeunik?>" class="form-control" placeholder="Masukkan ID ">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="jenjang_partisipasi" type="text" class="form-control" placeholder="Masukkan " required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="bobot_partisipasi" type="text" class="form-control" placeholder="Masukkan " required>
                  </div>
                </div>
