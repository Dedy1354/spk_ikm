      ...
      <h1>
        Tambah Data SDM
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?= base_url('index.php/admin/C_sdm/proses_tambah_data_sdm') ?>" method="POST" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="id_sdm" type="text" readonly value="<?=$kodeunik?>" class="form-control" placeholder="Masukkan ID ">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="jenjang_sdm" type="text" class="form-control" placeholder="Masukkan " required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="bobot_sdm" type="text" class="form-control" placeholder="Masukkan " required>
                  </div>
                </div>
