...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Tambah Data Ketersediaan Mesin
      </h1>
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?= base_url('index.php/admin/C_ketersediaan/proses_tambah_data_ketersediaan_mesin') ?>" method="POST" class="form-horizontal">
              <div class="box-body">

                <div class="form-group"> 
                  <label class="col-sm-2 control-label">ID KETERSEDIAAN MESIN</label>

                  <div class="col-sm-10">
                    <input name="id_ketersediaan_mesin" type="text" readonly value="<?=$kodeunik?>" class="form-control" placeholder="Masukkan ID ">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="jenjang_ketersediaan_mesin" type="text" class="form-control" placeholder="Masukkan " required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="bobot_ketersediaan_mesin" type="text" class="form-control" placeholder="Masukkan " required>
                  </div>
                </div>
