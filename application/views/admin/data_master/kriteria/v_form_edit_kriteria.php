  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>index.php/admin/C_kriteria">kriteria</a></li>
      </ol>
    </section>
          <div class="box">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?= base_url('index.php/admin/C_kriteria/proses_edit_data_kriteria')?>" method="POST" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="id_kriteria" readonly value="<?= $kriteria->ID_KRITERIA ?>" type="text" class="form-control" placeholder="Masukkan ID woyyyy">
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="nama_kriteria" value="<?= $kriteria->NAMA_KRITERIA ?>" type="text" class="form-control" placeholder="Masukkan " required>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="bobot_kriteria" value="<?= $kriteria->BOBOT_KRITERIA ?>" type="text" class="form-control" placeholder="Masukkan " required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input name="keterangan_kriteria" value="<?= $kriteria->KETERANGAN_KRITERIA ?>" type="text" class="form-control" placeholder="Masukkan " required>
                  </div>
                </div>
